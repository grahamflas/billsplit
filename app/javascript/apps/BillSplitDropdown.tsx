  ...
  return (
    <Menu>
      ...
      <MenuItems
        ...
        className="w-40 origin-top-right rounded-xl bg-white p-1 transition duration-100 ease-out [--anchor-gap:--spacing(1)] focus:outline-none data-closed:scale-95 data-closed:opacity-0"
      >
